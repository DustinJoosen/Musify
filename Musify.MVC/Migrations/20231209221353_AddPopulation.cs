        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, 2, 170, new DateTime(1955, 12, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Folsom Prison Blues" },
                    { 9, 2, 215, new DateTime(2002, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hurt" },
                    { 10, 2, 165, new DateTime(1971, 3, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Man in Black" },
                    ...
                    { 19, 4, 308, new DateTime(2013, 7, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Holy Grail" },
                    { 20, 4, 306, new DateTime(1999, 9, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Big Pimpin'" },
                    ...
                    { 40, 8, 231, new DateTime(2014, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bad Blood" },
                    { 41, 9, 270, new DateTime(2014, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Uptown Funk" },
                    { 42, 9, 220, new DateTime(2010, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Just the Way You Are" },
                    { 43, 9, 223, new DateTime(2010, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Grenade" },
                    { 44, 9, 225, new DateTime(2016, 10, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "24K Magic" },
                    { 45, 9, 232, new DateTime(2012, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Locked Out of Heaven" },
                    { 46, 10, 231, new DateTime(1976, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Go Your Own Way" },
                    { 47, 10, 256, new DateTime(1977, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dreams" },
                    { 48, 10, 276, new DateTime(1977, 2, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "The Chain" },
                    { 49, 10, 207, new DateTime(1975, 7, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Landslide" },
                    { 50, 10, 268, new DateTime(1975, 2, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rhiannon" },
                    { 51, 11, 219, new DateTime(1966, 5, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "Paint It Black" },
                    { 52, 11, 366, new DateTime(1968, 12, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sympathy for the Devil" },
                    { 53, 11, 271, new DateTime(1969, 12, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gimme Shelter" },
                    { 54, 11, 275, new DateTime(1973, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Angie" },
                    { 55, 11, 227, new DateTime(1981, 8, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Start Me Up" },
                    { 56, 12, 366, new DateTime(1975, 10, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bohemian Rhapsody" },
                    { 57, 12, 218, new DateTime(1980, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Another One Bites the Dust" },
                    { 58, 12, 122, new DateTime(1977, 10, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "We Will Rock You" },
                    { 59, 12, 298, new DateTime(1976, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Somebody to Love" },
                    { 60, 12, 210, new DateTime(1979, 1, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Don't Stop Me Now" },
                    { 61, 13, 208, new DateTime(1979, 7, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Highway to Hell" },
                    { 62, 13, 255, new DateTime(1980, 7, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Back in Black" },
                    { 63, 13, 292, new DateTime(1990, 9, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Thunderstruck" },
                    { 64, 13, 210, new DateTime(1980, 7, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "You Shook Me All Night Long" },
                    { 65, 13, 209, new DateTime(1975, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "T.N.T." },
                    { 66, 14, 313, new DateTime(1969, 7, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Space Oddity" },
                    { 67, 14, 370, new DateTime(1977, 9, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Heroes" },
                    { 68, 14, 324, new DateTime(1983, 4, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Let's Dance" },
                    { 69, 14, 258, new DateTime(1972, 4, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Starman" },
                    { 70, 14, 224, new DateTime(1971, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Life on Mars?" },
                    { 71, 15, 177, new DateTime(2017, 3, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "HUMBLE." },
                    { 72, 15, 309, new DateTime(2015, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Alright" },
                    { 73, 15, 185, new DateTime(2017, 4, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "DNA." },
                    { 74, 15, 259, new DateTime(2012, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Swimming Pools (Drank)" },
                    { 75, 15, 234, new DateTime(2015, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "King Kunta" },
                    { 76, 16, 219, new DateTime(2014, 8, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Shake It Off" },
                    { 77, 16, 231, new DateTime(2014, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Blank Space" },
                    { 78, 16, 235, new DateTime(2008, 9, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Love Story" },
                    { 79, 16, 231, new DateTime(2008, 11, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "You Belong with Me" },
                    { 80, 16, 231, new DateTime(2014, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bad Blood" },
                    ...
                    { 83, 17, 223, new DateTime(2010, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Grenade" },
                    ...
                    { 92, 19, 366, new DateTime(1968, 12, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sympathy for the Devil" },
                    { 93, 19, 271, new DateTime(1969, 12, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gimme Shelter" },
                    { 94, 19, 275, new DateTime(1973, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Angie" },
